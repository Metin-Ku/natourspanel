...
const initializeDataTable = async function () {
  try {
    ...
    fields = fields + ',link';
    const url = `${BASE_URL}/api/v1/sliders?fields=${fields}`;
    ...
    dataTable = $('#dataTable').DataTable({
          ...
          render: function (data, type, row) {
            ...
            <div class="table-photo">
              <a href="${row.link}" target="_blank">
                <img src="/img/sliders/thumb/${row.imageOriginal}" alt=""/>
              </a>
            </div>`;
          },
        },
        ...
        },
        {
          ...
          render: function (data, type, row) {
            ...
            <div class="table-actions">
              <a class="table-actions__edit" href="${base}/slider/edit/${row._id}"><svg><use xlink:href="/img/icons.svg#icon-edit"></use></svg></a>
      ...
      columnDefs: [
        {
          targets: 4, // 10. sütun (active) için özel sıralama
          orderData: [4, 5], // Veriyi sıralarken kullanılacak sıralama dizini
